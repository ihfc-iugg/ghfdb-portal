...
function query_cbar(x, alpha) {
  ...
  var b_values = [];
  for (i in cbar) {
      x_values.push(cbar[i][0]);
      r_values.push(cbar[i][1][0]);
      g_values.push(cbar[i][1][1]);
      b_values.push(cbar[i][1][2]);
  }
  ...
  var r = Math.round(255*enforceBounds(r));
  var g = Math.round(255*enforceBounds(g));
  var b = Math.round(255*enforceBounds(b));
