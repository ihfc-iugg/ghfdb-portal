...
# ─────────────────────────────────────────────────────────────────────────────
# US1 — Site and measurement persistence
# ─────────────────────────────────────────────────────────────────────────────


@pytest.mark.django_db
def test_heat_flow_site_persistence(dataset):
    """
...
@pytest.mark.django_db
def test_heat_flow_site_explo_purpose_m2m(dataset):
    """
...
@pytest.mark.django_db
def test_interval_links_to_site(dataset, site_fixture):
    """
...
@pytest.mark.django_db
def test_heat_flow_corrections(dataset, interval_fixture, child_fixture):
    """
...
@pytest.mark.django_db
def test_heat_flow_save_rejects_wrong_sample(site_fixture, child_fixture):
    """
...
@pytest.mark.django_db
def test_thermal_gradient_save_rejects_wrong_sample(site_fixture, gradient_fixture):
    """
...
@pytest.mark.django_db
def test_value_non_nullable_thermal_gradient(dataset, interval_fixture):
    """
...
@pytest.mark.django_db
def test_value_non_nullable_interval_conductivity(dataset, interval_fixture):
    """
...
@pytest.mark.django_db
def test_heat_flow_allows_null_gradient_and_conductivity(dataset, interval_fixture):
    """
...
@pytest.mark.django_db
def test_zero_thickness_interval_rejected(dataset, site_fixture):
    """
...
@pytest.mark.django_db
def test_valid_interval_passes_clean(dataset, site_fixture):
    """
...
# ─────────────────────────────────────────────────────────────────────────────
# US2 — Parent–child aggregation
# ─────────────────────────────────────────────────────────────────────────────


@pytest.mark.django_db
def test_parent_children_aggregation(dataset, site_fixture, interval_fixture):
    """
...
@pytest.mark.django_db
def test_parent_delete_sets_child_null(dataset, site_fixture, interval_fixture):
    """
...
@pytest.mark.django_db
def test_unique_parent_per_site_app_level(dataset, site_fixture):
    """
...
@pytest.mark.django_db
def test_unique_parent_per_site_db_level(dataset, site_fixture):
    """
...
@pytest.mark.django_db
def test_parent_with_zero_children_is_valid(dataset, site_fixture):
    """
...
@pytest.mark.django_db
def test_parent_save_rejects_wrong_sample(dataset, interval_fixture, parent_fixture):
    """
...
# ─────────────────────────────────────────────────────────────────────────────
# US3 — Marine probe metadata
# ─────────────────────────────────────────────────────────────────────────────


@pytest.mark.django_db
def test_probe_metadata_linked_to_interval(dataset, site_fixture, interval_fixture):
    """
...
@pytest.mark.django_db
def test_interval_without_probe_raises(dataset, site_fixture):
    """
...
# ─────────────────────────────────────────────────────────────────────────────
# Phase 8 Polish — HeatFlowCorrection status/type validation (T057)
# ─────────────────────────────────────────────────────────────────────────────


@pytest.mark.django_db
def test_correction_valid_status_accepted(child_fixture):
    """
...
@pytest.mark.django_db
def test_correction_invalid_status_rejected(child_fixture):
    """
...
@pytest.mark.django_db
def test_correction_unspecified_always_valid(child_fixture):
    """
...
@pytest.mark.django_db
def test_correction_invalid_type_rejected(child_fixture):
    """
