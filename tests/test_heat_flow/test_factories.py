...
@pytest.mark.django_db
def test_heat_flow_site_factory_save():
...
@pytest.mark.django_db
def test_heat_flow_interval_factory_save():
...
@pytest.mark.django_db
def test_parent_heat_flow_factory_save():
...
@pytest.mark.django_db
def test_probe_metadata_factory_save():
