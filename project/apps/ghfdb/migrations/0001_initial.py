# Generated by Django 4.2.1 on 2023-05-13 18:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("controlled_vocabulary", "0002_controlledvocabulary_description_af_and_more"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expedition",
                    models.CharField(
                        help_text="Specify the expedition, cruise, platform or research vessel where the marine heat flow survey was conducted. Only applies to marine probe sensing and drillings. Examples: Expedition cruise number OR R/V Ship OR D/V Platform",
                        max_length=255,
                        null=True,
                ...
                (
                    ...
                    geoluminate.contrib.controlled_vocabulary.fields.VocabularyField(
                        blank=True,
                        help_text="Main purpose of the original excavation providing access for the temperature sensors.",
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="+",
                        to="controlled_vocabulary.controlledvocabulary",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="This is the numeric identifier used in old forms of the GHFDB to identify measurements",
                        null=True,
                        verbose_name="Historic ID",
                    ),
                ),
                (
                    "qc",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "interval",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="ghfdb.interval"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                help_text="The publication or other reference from which the measurement was reported.",
                on_delete=django.db.models.deletion.CASCADE,
